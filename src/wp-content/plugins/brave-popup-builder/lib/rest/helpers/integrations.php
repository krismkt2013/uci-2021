...
function bravepop_add_to_newsletter($actionType='form', $type, $emailValue, $listID, $nameValue='', $phoneValue='', $customFields=array(), $tags=array(), $userData=array()){
   ...
   if( $emailValue && $listID){
      ...
      if(isset($service)){
         ...
         $subScriptionSuccess = $service->add_to_lists($emailValue, $listID, $nameValue, '', $phoneValue, $customFields, $tags, $userSync);
