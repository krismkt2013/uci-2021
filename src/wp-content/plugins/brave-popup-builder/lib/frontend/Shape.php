...
if ( ! class_exists( 'BravePop_Element_Shape' ) ) {
   ...
   class BravePop_Element_Shape {
      ...
      public function render( ) { 
         ...
         $tooltip = !empty($this->data->tooltip) ? ' onmouseenter="brave_tooltip_open(\''.$this->data->id.'\', \''.esc_attr($this->data->tooltip).'\', \''.($this->data->tooltipPos).'\')" onmouseleave="brave_tooltip_close()"' : ''; 
