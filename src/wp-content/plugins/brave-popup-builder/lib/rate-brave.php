...
if ( ! class_exists( 'BravePopup_Review_Notice' ) ) {
    class BravePopup_Review_Notice {
      ...
      public function bravepop_review_notice(){
            ...
            $messages = esc_html__( "Hi there! Great to see you have created an Awesome Popup with Brave Builder. If you like the plugin please consider rating it. It would mean the world to us.", 'bravepop' );
            $rateBtn = 'Rate';
