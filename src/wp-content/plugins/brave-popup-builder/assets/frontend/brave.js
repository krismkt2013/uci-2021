...
function brave_submit_form(event, settings){
   ...
   if(settings.quiz){
      ...
      quizData = {availableScore: availableScore, userScore: quizScore, userCorrect: quizCorrect, totalQuestions: settings.totalQuestions, scoring: settings.scoring}
   }
   ...
   if(formErrors.length === 0){
      ...
      var finalData = { formData: JSON.stringify(finalFieldsData), popupID: settings.popupID, formID: settings.formID, stepID: settings.stepID, quizData: JSON.stringify(quizData), cookieConditions:"", device: settings.device, security: security, action: 'bravepop_form_submission' };
