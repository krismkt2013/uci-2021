...
<div id='ueepb-slider-container-<?php echo $id_int; ?>' class='ueepb-slider-active jssor_slider_outer_container' style='position: relative; top: 0px; left: 0px; width:<?php echo $slider_width; ?>px;height:<?php echo $slider_height; ?>px;' >
    ...
    <div u='slides' class='jssor_slider_slides' style='width:<?php echo $slider_width; ?>px;height:<?php echo $slider_inner_height; ?>px;cursor:default;overflow:hidden;' >
        ...
        ?>
                    <div class='ueepb-front-slider-single'>
