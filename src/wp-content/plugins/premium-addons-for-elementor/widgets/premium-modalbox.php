...
class Premium_Modalbox extends Widget_Base
{
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control('premium_modal_box_animation',
			[
        ...
        $this->add_control('premium_modal_box_animation_duration',
			[
        ...
        $this->add_control('premium_modal_box_animation_delay',
			[
        ...
        $docs = [
            'https://premiumaddons.com/docs/modal-box-widget-tutorial/' => 'Getting started »',
            'https://premiumaddons.com/docs/how-can-i-insert-a-video-box-inside-premium-modal-box-widget/' => 'How Can I Insert a Video Box inside Premium Modal Box Widget »',
        ];
    ...
    protected function render() {
        ...
        $this->add_render_attribute( 'dialog', 'data-modal-animation',
            [
                $animation_class,
                $animation_dur,
            ]
