...
class Premium_Button extends Widget_Base {
    ...
    protected function _register_controls() {
        ...
        $docs = [
            'https://premiumaddons.com/docs/button-widget-tutorial' => 'Getting started »',
            'https://premiumaddons.com/docs/how-can-i-open-an-elementor-popup-using-premium-button' => 'How to open an Elementor popup using button widget »',
            'https://premiumaddons.com/docs/how-to-play-pause-a-soundtrack-using-premium-button-widget' => 'How to play/pause a soundtrack using button widget »',
            'https://premiumaddons.com/docs/how-to-use-elementor-widgets-to-navigate-through-carousel-widget-slides/' => 'How To Use Premium Button To Navigate Through Carousel Widget Slides »'
        ];
