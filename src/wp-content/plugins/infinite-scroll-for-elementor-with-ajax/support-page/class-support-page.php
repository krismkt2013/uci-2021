 ...
 *******************************/
add_action('wp_head', 'pd_is_support_form_ajax_header');

if( !function_exists('pd_is_support_form_ajax_header') )
{
	function pd_is_support_form_ajax_header() 
	{
	...
	} //End of pd_is_support_form_ajax_header
 ...
 *******************************/
add_action( 'wp_ajax_process_pd_is_promo_form', 'process_pd_is_promo_form' );

if( !function_exists('process_pd_is_promo_form') )
{
	function process_pd_is_promo_form()
	{
 ...
 *******************************/
if( !class_exists('WBELISSupportPage') ){


	class WBELISSupportPage{
		...
		function __construct( $plugin_slug = null )
		{
			...
			//add_action( 'wp_ajax_process_pd_is_promo_form', array(&$this,'process_pd_is_promo_form') );
		...
		{                     
		// echo $hook; die();            
		   if( $hook == 'infinite-scroll-for-elementor_page_wb-page-pd_is-support' ){	   	
		...
		function show_promo_page_callback_func()
		{
			add_submenu_page(
				...
				'manage_options',
				$this->page_slug,
				array(&$this, 'pd_ispromo_support_page_callback_func' )
			);
		 ...
		 *******************************/
		function pd_ispromo_support_page_callback_func()
		{
			
			?>
				
				<div class="pd_is-support-page-wrapper">
			...
			<?php
		} //End of pd_ispromo_support_page_callback_function
		
		
	
	} //End of the class WBELISSupportPage
...
//Supply Unique Promo Page Slug as the constructor parameter of the class WBELISSupportPage. ex: sld-page-2124a to the constructor

//Please create an unique instance for your use, example: $instance_sldf2

$instance = new WBELISSupportPage('pd_is-support');

if( is_admin() )
{
	$instance->plugin_menu_slug = "pd-infinite-scroll"; //Edit Value
	$instance->plugin_name = "Infinite Scroll for Elementor with Ajax"; //Edit Value
